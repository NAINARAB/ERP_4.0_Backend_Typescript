...
import { BrandMaster, brandCreateSchema, brandUpdateSchema } from '../../models/masters/brand';
...
export const createBrand = async (req: Request, res: Response) => {
    try {
        const validatedBody = validateBody(brandCreateSchema, req.body, res);
...
export const updateBrand = async (req: Request, res: Response) => {
    try {
        ...
        const validatedBody = validateBody(brandUpdateSchema, req.body, res);
        if (!validatedBody) return;
